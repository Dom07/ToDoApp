...
public class SqLiteTaskHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE TASK_LIST (TASK_ID INTEGER PRIMARY KEY AUTOINCREMENT, TASK_NAME TEXT, TASK_TAGS TEXT, TASK_END_DATE VARCHAR(11), TASK_END_TIME VARCHAR(6), TASK_STATUS INT(1))");
    }
